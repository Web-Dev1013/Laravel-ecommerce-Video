				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="">Contácto</a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h4>Contáctenos</h4>
									<h3>Estamos para serviles y buscar los mejores videojuegos que usted le gustan, para que los pueda conprar y ubicar de forma más rapida y agíl. @auth @else<span style="font-size:12px;" class="text-danger">[You need to login first]</span>@endauth</h3>
								</div>
